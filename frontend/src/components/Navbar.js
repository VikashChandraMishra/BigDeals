...
const Navbar = () => {
    ...
    if (location.pathname !== "/v/pt/pdf")
        return (
            <nav className="shadow-md w-full bg-blue-800">
                        ...
                        <div className="flex flex-col md:flex-row justify-between w-full">
                            <div className="flex flex-col md:flex-row items-start md:items-center md:space-x-1" id="menu">
                                ...
                                }
                                {
                                    ...
                                    <Link to="/" className="text-xs md:text-lg px-2 py-4 text-slate-50 font-semibold hover:text-red-500 transition duration-300" onClick={logout}
                                    >Log Out</Link>
                                }
